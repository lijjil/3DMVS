...
*/
enum EINTRINSIC     // 源码所给出的相机模型
{
  PINHOLE_CAMERA_START = 0,
  PINHOLE_CAMERA,         // No distortion              // 无畸变
  PINHOLE_CAMERA_RADIAL1, // radial distortion K1       // 径向畸变K1
  PINHOLE_CAMERA_RADIAL3, // radial distortion K1,K2,K3 // 径向畸变K1,K2,K3
  // 径向畸变K1，K2，K3，切向畸变T1，T2
