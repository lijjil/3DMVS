...
{
public:
	KMatrix K; // the intrinsic camera parameters (3x3) 内参矩阵
	RMatrix R; // rotation (3x3) and                    旋转矩阵
	CMatrix C; // translation (3,1), the extrinsic camera parameters    相机中心在世界坐标系中的位置
